        ...
        const lastCarBefore = document.getElementById("before");
         ...
         const changeDirctionSVG = 
         `
                   <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	                  width="30px" height="30px" viewBox="0 0 269.283 269.283"
	                  xml:space="preserve"> 
                     <g>
         ...
         let myCard = [];
         let order = -1;
        function deletColorEvent(){
            const colorDivs = document.querySelectorAll('.theColorDivs');
         ...
         function createFourColor (cardOpj){
                ...
                blackCard.appendChild(cardText);
         ...
         function blackCard(cardOpj){
            ...
            if (blackCard.textContent === "select color"){
                createFourColor(cardOpj);
            }
            else {
                blackCard.onclick = () => {
                   createFourColor(cardOpj)
         ...
         function creatDiv (father , text , Color)
         {
            ...
            newDiv.style.backgroundColor = Color;
                ...
                if (text === "change dirction") 
               text = changeDirctionSVG;
         ...
         socket.on('lastcard' , data => {
            ...
            const newDiv = document.createElement('div');
            newDiv.id = 'bodyCard';
            newDiv.style.backgroundColor = data.card.color;

                if (data.card.number === "change dirction") 
